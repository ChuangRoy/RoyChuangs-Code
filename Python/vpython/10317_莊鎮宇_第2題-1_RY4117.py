...
earth.v = vec(-v0 / 10, 0, 0)
satellite = sphere(pos=vec(H , -Re, 0), radius=10, color=color.red, make_trail=True, retain=50)
satellite.v = vec(-v0 , v0,0)
...
while mag(satellite.pos - earth.pos) >= Re:
    ...
    f1.plot(pos=(t, abs(mag(satellite.v))))
    t += dt